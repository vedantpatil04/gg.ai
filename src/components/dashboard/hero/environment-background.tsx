  ...
  return (
    <>
      ...
      {imageUrl && (
        ...
        >
          <div
            className="absolute inset-0 bg-cover bg-no-repeat transition-all duration-700 bg-[position:50%_25%] sm:bg-[position:50%_28%] md:bg-[position:50%_35%] lg:bg-[position:50%_32%] xl:bg-[position:50%_28%]"
            style={{
