...
export const MOCK_TICKETS: SupportTicket[] = [
  ...
  {
    id: "TKT-2005",
    subject: "GreenGuard Intelligence Center daily brief fails for custom district scope",
    category: "Technical Issue",
    status: "closed",
    priority: "medium",
    ...
    department: "GreenGuard Intelligence Center",
    environment: "Production",
    estimatedResponse: "Resolved",
...
export const FEATURE_REQUESTS: FeatureRequest[] = [
  ...
  {
    id: "fr-005",
    title: "GreenGuard Intelligence Center conversation history and saved queries",
    description: "Save GreenGuard Intelligence Center sessions so users can revisit previous analyses without re-running queries.",
