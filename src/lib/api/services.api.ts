...
export const complaintApi = {
  ...
  acceptResolution: (id: string, data?: { feedback?: string }) =>
    client.post(`/complaints/${id}/accept`, data ?? {}).then((r) => r.data),
  ...
  citizenRequestRework: (id: string, data: { reason: string; comments?: string }) =>
    client.post(`/complaints/${id}/request-rework`, data).then((r) => r.data),
};
